...
module.exports = configure(function (ctx) {
  return {
    ...
    boot: ['axios', 'notify-defaults', 'vue-plyr'],
    ...
    build: {
      ...
      env: {
        ...
        CLIENT_ID: process.env.KEYCLOAK_CLIENT_ID_ENV,
        KEYCLOAK_URL: process.env.KEYCLOAK_URL_ENV,
        KEYCLOAK_REALM: process.env.KEYCLOAK_REALM_ENV
      },
      // rawDefine: {}
    ...
    framework: {
      ...
      // Quasar plugins
      plugins: ['Cookies', 'LoadingBar', 'Notify'],
    },

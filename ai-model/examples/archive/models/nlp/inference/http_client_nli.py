...
def run_inference(
    ...
    triton_client = tritonhttp.InferenceServerClient(url=url, verbose=VERBOSE)
    print(
...
if __name__ == "__main__":
    run_inference(
        "The nebulas dance divinely in our heavenly skies",
        "This text is about space and cosmos",
        "xlm_roberta_zsl",
    )
